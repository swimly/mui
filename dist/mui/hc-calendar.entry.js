    ...
    getMonthDaysArray(year, month) {
        ...
        for (var i = 0; i < row; i++) {
            ...
            for (var j = 0; j < 7; j++) {
                ...
                arr.push(Object.assign({ year: y, month: m, day: day, date: `${y}/${m}/${day}` }, this.solar2lunar(y, m, day)));
            }
            dayArr.push(arr);
        }
        return dayArr;
...
const Calendar = class {
    ...
    render() {
        ...
        return (h(Host, null, h("div", { class: "head" }, h("div", { class: "left" }, h("span", { class: "year" }, this.year, "\u5E74"), h("span", { class: "month" }, this.month, "\u6708"), h("span", { class: "diff" })), (() => {
            if (this.vshape) {
                return (h("button", { class: "circle", onClick: this.toggleView.bind(this) }, this.type == 'month' ? '周' : '月'));
            }
        })(), h("hc-icon", { name: "arrow-lift", onClick: this.onDateChange.bind(this, 'minus') }), h("hc-icon", { name: "arrow-right", onClick: this.onDateChange.bind(this, 'plus') })), h("ul", { class: "weeks" }, h("li", null, "\u4E00"), h("li", null, "\u4E8C"), h("li", null, "\u4E09"), h("li", null, "\u56DB"), h("li", null, "\u4E94"), h("li", null, "\u516D"), h("li", null, "\u65E5")), h("div", { class: this.getCssClassMap2(), style: { transform: `translateX(${-el.offsetWidth}px)` } }, data.map((month) => {
            if (type == 'month') {
                return (h("div", Object.assign({ class: "month" }, { month: month.month }), month.data.map((week) => {
                    return (h("ul", { class: "week", style: { width: `${el.offsetWidth}px` } }, week.map((day) => {
                        return (h("li", Object.assign({ id: month.month == day.month ? `day${day.date.split('-').join('')}` : '', onClick: this.itemClick.bind(this, day), class: this.getCssClassMap(day, month) }, { year: day.cYear, month: day.cMonth, day: day.cDay, weekday: day.nWeek, week: calendar.getWeekOfYear(day.cYear, day.cMonth, day.cDay) }), h("p", null, day.day), h("h2", null, this.lunar ? day.isTerm ? day.Term : day.IDayCn : '')));
                    })));
                })));
            }
            else {
                return (h("ul", Object.assign({ class: "week" }, { year: month.year, week: month.week }, { style: { width: `${el.offsetWidth}px` } }), month.data.map((day) => {
                    return (h("li", Object.assign({ onClick: this.itemClick.bind(this, day), class: this.getCssClassMap1(day) }, { year: day.cYear, month: day.cMonth, day: day.cDay, weekday: day.nWeek, week: calendar.getWeekOfYear(day.cYear, day.cMonth, day.cDay) }), h("p", null, day.cDay), h("h2", null, this.lunar ? day.isTerm ? day.Term : day.IDayCn : '')));
                })));
            }
        }))));
    }
...
export { Calendar as hc_calendar };
