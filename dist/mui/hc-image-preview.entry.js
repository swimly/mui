import { r as registerInstance$1, h as h$1, H as Host$1, c as getElement$1 } from './core-3c51ccf2.js';
...
const Swiper = class {
    ...
    bindTouch() {
        ...
        const hammer$1 = new hammer(this.el);
        this.direction == 'horizontal' ? hammer$1.get('pan').set({ direction: hammer.DIRECTION_HORIZONTAL }) : hammer$1.get('pan').set({ direction: hammer.DIRECTION_VERTICAL });
...
const ImagePreview = class {
    ...
    render() {
        ...
        return (h$1(Host$1, null, h$1("slot", null), h$1("div", { onClick: () => { this.visible = false; }, class: this.getCssClassMap() })));
    }
    /**
   * 已服务的形式调用
   */
